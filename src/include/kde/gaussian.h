...
#ifndef __XOKDEPP_GAUSSIAN_H__
#define __XOKDEPP_GAUSSIAN_H__

#include "kde/priv/gaussian_base.h"
#include "kde/priv/gaussian_full.h"
#include "kde/priv/gaussian_diagonal.h"

#endif /* __XOKDEPP_GAUSSIAN_H__ */
